...
class _AddVehicleBottomSheetState extends State<AddVehicleBottomSheet> {
                  ...
                  builder: (context, state) {
                    return Column(
                      ...
                      children: [
                        ...
                        state.carCategories == null || state.carCategories!.data == null || state.carCategories!.data!.isEmpty
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<int>(
                              ...
                              isExpanded: true,
                              hint: const Text("Vehicle Type", style: TextStyle(color: Colors.grey)),
                              ...
                              onChanged: (int? newValue) {
                                if (newValue != null) {
                                  context.read<VehicleBloc>().add(SelectCarCategory(newValue));
                                }
                              },
                            ),
                          ),
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            if (picked != null) {
                              insuranceExpiryCtrl.text = "${picked.year}-${picked.month.toString().padLeft(2, '0')}-${picked.day.toString().padLeft(2, '0')}";
                            }
                          },
                          child: AbsorbPointer(
                        ...
                        _buildImagePickerBox(
                          ...
                          onTap: () {
                            context.read<VehicleBloc>().add(PickSpecificDocument("insurance"));
                          },
                        ),
                        const SizedBox(height: 25),
                          ...
                          children: [
                            Expanded(
                              child: _buildImagePickerBox(
                                ...
                                onTap: () {
                                  context.read<VehicleBloc>().add(PickSpecificDocument("rcFront"));
                                },
                              ),
                            ),
                            ...
                            Expanded(
                              child: _buildImagePickerBox(
                                ...
                                onTap: () {
                                  context.read<VehicleBloc>().add(PickSpecificDocument("rcBack"));
                                },
                              ),
                            ),
                          ],
                          ...
                          children: [
                            Expanded(
                              child: _buildImagePickerBox(
                                ...
                                onTap: () {
                                  context.read<VehicleBloc>().add(PickSpecificDocument("car1"));
                                },
                              ),
                            ),
                            const SizedBox(width: 15),
                            Expanded(
                              child: _buildImagePickerBox(
                                ...
                                onTap: () {
                                  context.read<VehicleBloc>().add(PickSpecificDocument("car2"));
                                },
                              ),
                            ),
                          ],
                        ...
                        CommonAppButton(
                          ...
                          onPressed: () {
                            if (state.selectedCarCategoryId == null || vehicleNumberCtrl.text.isEmpty) {
                              ScaffoldMessenger.of(context).showSnackBar(
                            ...
                            final fields = {
                              "car_category_id": state.selectedCarCategoryId.toString(),
                            ...
                            if (state.insuranceImage != null) files["insurance_document"] = state.insuranceImage!;
                            if (state.rcFrontImage != null) files["rc_front_image"] = state.rcFrontImage!;
                            if (state.rcBackImage != null) files["rc_back_image"] = state.rcBackImage!;
                            if (state.carImage1 != null) files["car_image1"] = state.carImage1!;
                            if (state.carImage2 != null) files["car_image2"] = state.carImage2!;
  ...
  Widget _buildImagePickerBox(BuildContext context, {required String title, File? imageFile, required VoidCallback onTap}) {

                                ...
                                child: Column(
                                  ...
                                  children: [
                                        ...
                                        children: [
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              ...
                                              children: [
                                                TextSpan(text: '${bookingData.pickupDate} '),
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          _priceBox("₹${bookingData.totalFare}", "Total Amount"),
                                          const SizedBox(width: 8),
                                          _priceBox("₹${bookingData.driverCommission}", "Driver's Earning", isEarning: true),
                                          const SizedBox(width: 8),
                                          _priceBox("₹${bookingData.driverCommission}", "Commission"),
                                        ],
                                      ),
                                    ),
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  color: const Color(0xffFCB117).withOpacity(0.1),
                                                  borderRadius: BorderRadius.circular(6),
                                                ),
                                                child: Row(
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: [
                                                    Image.asset("assets/images/chatNew.png", height: 16),
                                                    const SizedBox(width: 8),
                                                    const Text(
                                                      "Chat",
                                                      style: TextStyle(color: Color(0xffFCB117), fontWeight: FontWeight.w600, fontSize: 13),
                                                    ),
                                                  ],
                                                ),
                                              ),
                                          ...
                                          Expanded(
                                            child: GestureDetector(
                                              ...
                                              child: Container(
                                                height: 40,
                                                decoration: BoxDecoration(
                                                  color: const Color(0xFFF45858).withOpacity(0.1),
                                                  borderRadius: BorderRadius.circular(6),
                                                ),
                                                child: const Center(
                                                  child: Text(
                                                    "Cancel",
                                                    style: TextStyle(color: Color(0xFFF45858), fontWeight: FontWeight.w600, fontSize: 13),
                                                  ),
                                                ),
                                              ),
                                            ),
